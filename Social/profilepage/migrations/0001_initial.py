    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_dt', models.DateTimeField(default=datetime.datetime(2020, 2, 27, 8, 57, 32, 117340))),
            ],
            options={
                'db_table': 'comments',
                'ordering': ['-created_dt'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('idx', models.AutoField(primary_key=True, serialize=False)),
                ('created_dt', models.DateTimeField(default=datetime.datetime(2020, 2, 27, 8, 57, 32, 132953))),
            ],
            options={
                'db_table': 'friends',
                'managed': False,
